...
export default function ResearchHighlights() {
  return (
    <section id="research highlights" className="py-12 relative" data-component="research">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {projects.map((project, index) => (
            <MotionWrapper key={project.title} delay={index * 0.2}>
              <GlassCard 
                className="group overflow-hidden dark:border-purple-500/10 h-full flex flex-col"
